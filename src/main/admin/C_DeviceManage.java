...
public class C_DeviceManage extends JFrame implements ActionListener{
	...
	Object[] columnNames = new Object[]{"d_deviceId", "d_deviceName", "d_classId", "d_specification", "d_manuId", "d_familyId"};
	...
	public C_DeviceManage() {
		...
		this.setTitle("Admin-deviceManagement");
		getContentPane().setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		panel = new JPanel();
		
		comboBox.setModel(new DefaultComboBoxModel<String>(new String[] {"deviceId", "deviceName", "classId", "manuId", "familyId"}));
		panel.add(comboBox);
